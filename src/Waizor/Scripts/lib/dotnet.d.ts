export declare namespace DotNet {
    ...
    export function attachDispatcher(
        dotNetCallDispatcher: DotNetCallDispatcher
    ): ICallDispatcher;
    /**
     ...
     */
    export function invokeMethodAsync<T>(
        assemblyName: string,
        methodIdentifier: string,
        ...args: any[]
    ): Promise<T>;
     ...
     */
    export function createJSStreamReference(
        streamReference: ArrayBuffer | ArrayBufferView | Blob | any
    ): any;
    /**
    ...
    export interface ICallDispatcher {
        ...
        endInvokeDotNetFromJS(
            asyncCallId: string,
            success: boolean,
            resultJsonOrExceptionMessage: string
        ): void;
        /**
         ...
         * @returns A promise representing the result of the operation.
         */
        invokeDotNetStaticMethodAsync<T>(
            assemblyName: string,
            methodIdentifier: string,
            ...args: any[]
        ): Promise<T>;
    ...
    export function findJSFunction(
        identifier: string,
        targetInstanceId: number
    ): Function;
    ...
    export class DotNetObject {
        ...
        invokeMethod<T>(methodIdentifier: string, ...args: any[]): T | null;
        invokeMethodAsync<T>(
            methodIdentifier: string,
            ...args: any[]
        ): Promise<T>;
